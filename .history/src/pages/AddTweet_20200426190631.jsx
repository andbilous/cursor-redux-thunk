...
export const AddTweet = () => {
  ...
  return (
    ...
    <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
      ...
      <Input value={content} onChange={(e)=>setContent(e.target.value)}  type="text" name="userName" id="userName" placeholder="userName" />
    </FormGroup>
    <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
      <Label for="avatar" className="mr-sm-2">Avatar</Label>
      <Input value={image} onChange={(e)=>setAvatar(e.target.value)} type="text" name="avatar" id="avatar" placeholder="http://" />
    </FormGroup>
    <Button onClick={
      ()=>{
        props.addUser({
