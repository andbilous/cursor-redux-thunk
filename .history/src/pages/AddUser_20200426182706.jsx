...
const AddUser = (props) => {
  ...
  return (
    ...
    <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
      ...
      <Input onChange={(e)=>setAvatar(e.target.value)}  type="text" name="userName" id="userName" placeholder="userName" />
    </FormGroup>
    <FormGroup className="mb-2 mr-sm-2 mb-sm-0">
      <Label for="avatar" className="mr-sm-2">Avatar</Label>
      <Input onChange={(e)=>setAvatar(e.target.value)} type="text" name="avatar" id="avatar" placeholder="Avatar" />
    </FormGroup>
    <Button onClick={
      ()=>{
        props.addUser({
